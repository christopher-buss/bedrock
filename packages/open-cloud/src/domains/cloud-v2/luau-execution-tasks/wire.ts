...
export interface LuauExecutionTaskWire {
	...
	/**
	 * ISO timestamp when the task was created; omitted from the create-task
	 * POST response.
	 */
	...
	/**
	 * ISO timestamp of the most recent state change; omitted from the
	 * create-task POST response.
	 */
