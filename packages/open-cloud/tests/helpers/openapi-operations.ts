...
/**
 * The HTTP methods the Roblox OpenAPI spec uses. `head`, `options`,
 * and `trace` are omitted because the spec does not define them.
 * Lowercased because spec keys are lowercase.
 */
