...
| Action          | Path                                                              | Use                                                     |
| --------------- | ----------------------------------------------------------------- | ------------------------------------------------------- |
| **Deploy**      | `christopher-buss/bedrock/packages/actions/deploy@actions-v0.1.1` | Full pipeline: deploy → mint token → reflow codegen.    |
| **Commit-back** | `christopher-buss/bedrock/packages/actions@actions-v0.1.1`        | Just the race-safe codegen reflow, to compose yourself. |
...
```yaml
- uses: christopher-buss/bedrock/packages/actions@actions-v0.1.1
  with:
    branch: main
    paths: src/shared/assets
