...
| [008](./008-zero-runtime-dependencies.md)    | Zero Runtime Dependencies in `@bedrock-rbx/open-cloud`    | Accepted | 2026-04-12 |
| [009](./009-result-types-over-exceptions.md) | Result Types Over Exceptions in `@bedrock-rbx/open-cloud` | Accepted | 2026-04-12 |
| [010](./010-sdk-managed-rate-limiting-and-retry.md) | SDK-Managed Rate Limiting and Retry in `@bedrock-rbx/open-cloud` | Accepted | 2026-04-12 |
